...
export class AuthService {
  ...
  public authenticate<T extends string | object = any>(name: string, userData?: any): Observable<T> {
        return this.oauth.authenticate<T>(name, userData);
    }

  public link<T extends string | object = any>(name: string, userData?: any): Observable<T> {
        return this.oauth.authenticate<T>(name, userData);
    }
